                            ...
                            <div class="col-lg-12 col-md-12 mt-25">
                                ...
                                <fieldset class="invoice-address form-group">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="0" id="customer_name" value="{{$customer_name}}"
                                                        readonly>
                                    </div>
                                </fieldset>
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 mt-25">
                                        <fieldset class="invoice-address form-group">
                                            <textarea class="form-control" rows="4" id="customer_address" value="{{$customer_address}}" readonly></textarea>
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-6 col-md-12 mt-25">
                                        <fieldset class="invoice-address form-group">
                                ...
                                <div class="invoice-item d-flex border rounded mb-1">
                                    <div class="invoice-item-filed row pt-1 px-2">
                                        <div class="col-12 col-md-4 form-group">
                                            <fieldset class="invoice-address form-group">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="0" id="topping" value="{{$topping_name}}"
                                                        readonly>
                                                </div>
                                            </fieldset>
                                        </div>
