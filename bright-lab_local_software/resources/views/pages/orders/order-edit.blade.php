                ...
                <div class="card">
                    <div class="card-body pb-0 mx-25">
                        ...
                        <div class="row mx-0">
                            <div class="col-xl-4 col-md-12 d-flex align-items-center pl-0">
                                ...
                                <input type="text" class="form-control pt-25 w-50" value="{{ $order_number }}" readonly>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="col-lg-12 col-md-12 mt-25">
                                        ...
                                        <select class="select2 form-control customer_select" name="customer">
                                            @foreach ($customers as $customer)
                                                @if ($customer->id == $customer_id)
                                                    ...
                                                    data-phone="{{ $customer->phone }}" selected>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 mt-25">
                                        <fieldset class="invoice-address form-group">
                                            <textarea class="form-control" rows="4" id="customer_address" readonly>{{$customer_address}}</textarea>
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-6 col-md-12 mt-25">
                                        <fieldset class="invoice-address form-group">
                                            <input type="text" class="form-control" id="customer_phone" value="{{$customer_phone}}" readonly>
                                        </fieldset>
                                    </div>
                                </div>
                    ...
                    <div class="card-body pt-50">
                        ...
                        <div class="invoice-product-details ">
                            <form class="form" method="POST" action="{{ asset('update-order') }}">
                                @csrf
                                <input type="hidden" name="customer_id" id="customer_id_input" value="{{$customer_id}}">
                                <input type="hidden" name="order_id" id="order_id_input" value="{{$order_number}}">
                                <div class="row mb-50">
                                ...
                                <div class="invoice-item d-flex border rounded mb-1">
                                    <div class="invoice-item-filed row pt-1 px-2">
                                                    ...
                                                    <select class="select2 form-control topping_select" name="topping_id">
                                                        ...
                                                        @foreach ($toppings as $topping)
                                                            @if ($topping->id == $topping_id)
                                                                ...
                                                                data-price="{{ $topping->topping_price }}" selected>
                                        ...
                                        <div class="col-md-4 col-12 form-group">
                                            <input type="number" class="form-control" placeholder="0" id="topping_price" value="{{$topping_price}}"
                                                readonly>
                                        </div>
                                        <div class="col-md-4 col-12 form-group">
                                            <input type="number" class="form-control" name="topping_qty" id="topping_qty" value="{{$topping_qty}}"
                                                placeholder="0">
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-md-7 offset-lg-7 col-12">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                    ...
                                                    <h6 class="invoice-subtotal-value mb-0" id="order_total">{{$topping_total}}</h6>
                                                </li>
                                ...
                                <div class="invoice-action-btn mb-1">
                                    <button type="submit" class="btn btn-light-success btn-block">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
